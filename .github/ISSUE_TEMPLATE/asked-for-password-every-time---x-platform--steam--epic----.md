...
1. Check the [Wiki - I need to enter a password every time I switch](https://github.com/TCNOCo/TcNo-Acc-Switcher/wiki/FAQ---More-Info#i-need-to-enter-a-password-every-time-i-switch) for solutions on what could be going wrong.
