...
namespace TcNo_Acc_Switcher_Server.Pages.Riot
{
    public class RiotSwitcherBase
    {
        ...
        {
            Globals.DebugWriteLine($@"[JSInvoke:Riot\RiotSwitcherBase.SwapToRiot] accName:{accName}");
        ...
        {
            Globals.DebugWriteLine($@"[JSInvoke:Riot\RiotSwitcherBase.RiotAddCurrent] accName:{accName}");
