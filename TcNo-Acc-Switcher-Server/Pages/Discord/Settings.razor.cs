...
namespace TcNo_Acc_Switcher_Server.Pages.Discord
{
    public partial class Settings
    {
        ...
        public static void ClearSettings()
        {
            ...
            AppData.ActiveNavMan.NavigateTo("/Discord?toast_type=success&toast_title=Success&toast_message=" + Uri.EscapeDataString(Lang["Toast_ClearedPlatformSettings", new { platform = "Discord" }]));
        }
        #endregion
