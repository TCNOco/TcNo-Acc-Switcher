...
class Notification {
    ...
    new(t) {
        //console.log(typeof t.renderTo);
        //console.log(t.renderTo);
        if (typeof t.renderTo == "string" && t.renderTo != "body") t.renderTo = $(t.renderTo)[0]; else delete t.renderTo; // unset if body
