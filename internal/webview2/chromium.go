...
type Chromium struct {
	...
	DataPath    string
	BrowserPath string
	// ProfileName isolates this view's cookies, storage and cache from every other
	// view sharing DataPath. Leave empty for the runtime's default profile.
	// Requires WebView2 110 or newer; Embed reports an error on older runtimes
	// rather than silently falling back to a shared profile.
	ProfileName                   string
