https://tcno.co/Projects/AccSwitcher/TcNo.Account.Switcher.x64.zip|https://tcno.co/Projects/AccSwitcher/TcNo.Account.Switcher.x32.zip
<?php
/*
    GOAL:
...
// Today's JSON file
$filename = __DIR__ ."/updatedata/".date("Y-m-d").".json";
