...
namespace TcNo_Acc_Switcher.Pages.General.Classes;
...
public class IconFactory
{
    ...
    public void SavePngsAsIcon(IEnumerable<Bitmap> images, Stream stream)
    {
        ...
        foreach (var image in orderedImages)
        {
            ...
            writer.Write((ushort)System.Drawing.Image.GetPixelFormatSize(image.PixelFormat));
    ...
    [SupportedOSPlatform("windows")]
    private static byte GetIconHeight(System.Drawing.Image image)
    {
    ...
    [SupportedOSPlatform("windows")]
    private static byte GetIconWidth(System.Drawing.Image image)
    {
    ...
    [SupportedOSPlatform("windows")]
    private static byte[] CreateImageBuffer(System.Drawing.Image image)
    {
    ...
    public bool CreateIcon(string sBgImg, string sFgImg, ref string icoOutput)
    {
        ...
        if (sBgImg.EndsWith(".svg") && !File.Exists(sBgImg.Replace(".svg",".png")))
        {
            ...
            {
                var fallbackBg = Path.Join(Globals.WwwRoot, "\\img\\BasicDefault.png");
        ...
        if (!File.Exists(sFgImg))
            sFgImg = Path.Join(Globals.WwwRoot, "\\img\\BasicDefault.png");
        ...
        CreateImage(ms, sFgImg, ms16, new System.Drawing.Size(16, 16));
        CreateImage(ms, sFgImg, ms32, new System.Drawing.Size(32, 32));
        CreateImage(ms, sFgImg, ms48, new System.Drawing.Size(48, 48));
        CreateImage(ms, sFgImg, ms256, new System.Drawing.Size(256, 256));
    ...
    public static void CreateImage(MemoryStream sBgImg, string sFgImg, MemoryStream output, System.Drawing.Size imgSize)
    {
