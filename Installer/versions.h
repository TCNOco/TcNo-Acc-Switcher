...
const std::string w_runtime_name = "Microsoft WebView2 Runtime",
	...
	d_runtime_name = "Microsoft .NET 6.0.19 Desktop Runtime",
	d_runtime = "https://dotnetcli.azureedge.net/dotnet/WindowsDesktop/6.0.19/windowsdesktop-runtime-6.0.19-win-x64.exe",
	d_exe = "windowsdesktop-runtime-6.0.19-win-x64.exe",

	a_runtime_name = "Microsoft ASP.NET Core 6.0.19 Runtime",
	a_runtime = "https://dotnetcli.azureedge.net/dotnet/aspnetcore/Runtime/6.0.19/aspnetcore-runtime-6.0.19-win-x64.exe",
	a_exe = "aspnetcore-runtime-6.0.19-win-x64.exe",
