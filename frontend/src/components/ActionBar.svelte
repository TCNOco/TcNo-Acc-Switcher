...
<span class="actionbar__status">{$actionBarStatus}</span>
  <div class="actionbar__actions">
    {#if isPlatformPage}
      ...
      {#if showSaveCurrent}
        <button
          class="btnicontext actionbar__save"
          type="button"
        ...
        <button
          ...
          >
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <path d="M12 2.25 4 5.3v5.8c0 5.05 3.35 9.5 8 10.65 4.65-1.15 8-5.6 8-10.65V5.3L12 2.25Zm0 2.15 6 2.3v4.4c0 3.9-2.45 7.45-6 8.55-3.55-1.1-6-4.65-6-8.55V6.7l6-2.3Z"/>
              <circle cx="9" cy="10" r="1.15"/>
              <circle cx="15" cy="10" r="1.15"/>
              <circle cx="9" cy="14" r="1.15"/>
              <circle cx="15" cy="14" r="1.15"/>
            </svg>
          </button
        >
      {/if}
    ...
    {:else}
      {#if isHomePage}
        ...
        >
      {/if}
      <button class="btnicontext actionbar__manage" aria-label={$t("Button_ManagePlatforms")} use:tooltip={$t("Tooltip_ManagePlatforms")} on:click={() => route.set({ page: 'manage-platforms'})}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free v5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/></svg>{$t("Button_ManagePlatforms")}</button>
    {/if}
