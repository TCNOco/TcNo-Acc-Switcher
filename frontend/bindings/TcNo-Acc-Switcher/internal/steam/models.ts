...
export class Settings {
    ...
    constructor($$source: Partial<Settings> = {}) {
        ...
        if (!("Steam_Admin" in $$source)) {
            this["Steam_Admin"] = false;
        }
        ...
        if (!("Steam_TrayAccNumber" in $$source)) {
            this["Steam_TrayAccNumber"] = 0;
        }
    ...
    static createFrom($$source: any = {}): Settings {
        ...
        if ("ShortcutsJson" in $$parsedSource) {
            $$parsedSource["ShortcutsJson"] = $$createField12_0($$parsedSource["ShortcutsJson"]);
        }
        if ("AccountNotes" in $$parsedSource) {
            $$parsedSource["AccountNotes"] = $$createField17_0($$parsedSource["AccountNotes"]);
        }
