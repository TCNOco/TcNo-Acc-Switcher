 ...
 */
export function GetStatsReport(): $CancellablePromise<$models.StatsReport> {
    return $Call.ByID(1408334).then(($result: any) => {
 ...
 */
export function ResetStatistics(): $CancellablePromise<void> {
    return $Call.ByID(3721775853);
}
 ...
 */
export function StatsAddPageTime(pagePath: string, seconds: number): $CancellablePromise<void> {
    return $Call.ByID(3966904607, pagePath, seconds);
}

/**
 * StatsRecordPageVisit increments the visit counter for a SPA route path (e.g. "/", "/settings").
 */
export function StatsRecordPageVisit(pagePath: string): $CancellablePromise<void> {
    return $Call.ByID(828076243, pagePath);
}
...
const $$createType4 = $models.StatsReport.createFrom;
const $$createType5 = $models.ResolvePlatformLaunchResult.createFrom;
